...
(function () {
  SQ.WriterPrompt = {
    ...
    buildSystem: function (gameState) {
      ...
      p += '{\n';
      p += '  "passage": "string — the narrative passage, 150-300 words. Use \\\\n\\\\n to separate paragraphs (at least 2-3 paragraphs).",\n';
      p += '  "choices": {\n';
    ...
    buildFinaleSystem: function (gameState, terminalType) {
      ...
      p += 'Respond with this exact JSON structure:\n';
      p += '{\n';
      p += '  "passage": "string — the conclusive narrative passage, 200-400 words. Use \\\\n\\\\n to separate paragraphs (at least 2-3 paragraphs)."\n';
      p += '}\n\n';
